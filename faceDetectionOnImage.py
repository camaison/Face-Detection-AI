...
face_coordinates = trained_face_data.detectMultiScale(grayscale) # Asssigning the nested list of cordinates of the faces detected to a variable face_coordinates
